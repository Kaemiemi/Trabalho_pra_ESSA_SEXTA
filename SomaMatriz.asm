.data
    size: .word 1000                # Tamanho da matriz (número de linhas/colunas)
    matriz1: .space 4000000           # Espaço para matriz 1 sizexsize e 4 bytes cada
    matriz2: .space 4000000           # Espaço para matriz 2 
    resultado: .space 4000000         # Espaço para matriz de resultado 
